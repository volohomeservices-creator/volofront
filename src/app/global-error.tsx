...
export default function GlobalError({
  ...
  return (
    <html lang="en">
      <body className="min-h-screen bg-[#D3D9D4] flex items-center justify-center p-6 font-sans">
        <div className="max-w-md w-full bg-white border border-[#124E66]/10 p-8 rounded-[2.5rem] shadow-xl text-center space-y-6">
          ...
          <div className="space-y-2">
            <h2 className="text-xl font-black text-slate-900 tracking-tight">Critical Application Error</h2>
            <p className="text-xs text-slate-500 leading-relaxed">
              A root-level layout rendering exception occurred. The application must be reloaded.
            </p>
          </div>
          <button
            type="button"
